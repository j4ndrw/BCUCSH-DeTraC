...
def extract_features(class_name, width, height, net: Net):
    features = []
...
def train_feature_extractor(
    ...
    for class_name in class_names:
        extracted_features = extract_features(class_name, 224, 224, net)
        np.save(os.path.join("../../../data/extracted_features/{class_name}.npy"), extract_features)
